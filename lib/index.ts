...
export const TokenContract = {
	abi: TokenABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};

export const ConservativeStakingPoolContract = {
	abi: ConservativeStakingPoolABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};
export const DynamicStakingPoolContract = {
	abi: DynamicStakingPoolABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};

export const ConservativeStakingContract = {
	abi: ConservativeStakingABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};

export const DynamicStakingContract = {
	abi: DynamicStakingABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};
export const LuckyRoundContract = {
	abi: LuckyRoundABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};
export const LuckyRoundBetContract = {
	abi: LuckyRoundBetABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};
export const PassContract = {
	abi: PassABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};

export const RouletteContract = {
	abi: RouletteABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};

export const RouletteBetContract = {
	abi: RouletteBetABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};

export const GameContract = {
	abi: PredictGameABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};

export const BetInterfaceContract = {
	abi: BetInterfaceABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};
...
export const MultimintContract = {
	abi: MultimintABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};
export const BetsMemoryContract = {
	abi: BetsMemoryABI,
};
export const AffiliateContract = {
	abi: AffiliateABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};
export const AffiliateFundContract = {
	abi: AffiliateFundABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};
export const PredictContract = {
	abi: PredictABI as readonly Narrow<Narrow<AbiConstructor | AbiError | AbiEvent | AbiFallback | AbiFunction | AbiReceive>>[],
};
...
export const defaultMulticall: Address = '0xcA11bde05977b3631167028862bE2a173976CA11';
